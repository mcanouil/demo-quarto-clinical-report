...
- feat: `clinical` format extension contributing a Typst format, with cover page, document control and approval page, running headers and footers, draft watermark, and landscape listings, and a matching HTML format with an SCSS theme.
