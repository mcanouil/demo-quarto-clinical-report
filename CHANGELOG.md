...
- fix: long tables and listings break across pages in the Typst output, repeating their header rows, instead of overflowing the page they start on; headings stay with the content that follows them.
